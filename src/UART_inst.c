      ...
      if(state == osOK)
      {
        ...
        switch(stateLeftElevator)
        {
          case STOPPED:
            ...
            if(string[0] == 'e' && string[1] == 'E' && (int)string[2] == 48 && (int)string[3] >= 49 && (int)string[3] <= 57)
            {
              level = ((int) string[3] - 0x30);
            }
            if(string[0] == 'e' && string[1] == 'E' && (int)string[2] != 48 && (int)string[3] >= 49 && (int)string[3] <= 53)
            {
              level = ((int) string[2] - 0x30)*10 + ((int) string[3] - 0x30);
            }
            /*
            if(string[0] == 'e' && string[1] == 'I')
            {
              level = ((int) string[2]) - 97;
            }
            */
          ...
          case GOING_UP:
            stateLeftElevator = GOING_UP;
            if(string[0] == 'e' && (int)string[1] >= 49 && (int)string[1] <= 57 && (int)string[2] == 0)
            {
              currentFloor = (int) string[1] - 0x30; //Atualiza o andar do elevador
            }
            if(string[0] == 'e'&& (int)string[1] == 49 && (int)string[2] >= 48 && (int)string[2] <= 53)
            {
              currentFloor = ((int) string[1] - 0x30)*10 + ((int) string[2] - 0x30); //Atualiza o andar do elevador
            }
      ...
      if(state == osOK)
      {
        ...
        switch(stateCentralElevator)
        {
          case STOPPED:
            ...
            if(string[0] == 'c' && string[1] == 'E' && (int)string[2] == 48 && (int)string[3] >= 49 && (int)string[3] <= 57)
            {
              level = ((int) string[3] - 0x30);
            }
            if(string[0] == 'c' && string[1] == 'E' && (int)string[2] != 48 && (int)string[3] >= 49 && (int)string[3] <= 53)
            {
              level = ((int) string[2] - 0x30)*10 + ((int) string[3] - 0x30);
            }
            /*
          ...
          case GOING_UP:
            stateCentralElevator = GOING_UP;
            if(string[0] == 'c' && (int)string[1] >= 49 && (int)string[1] <= 57 && (int)string[2] == 0)
            {
              currentFloor = (int) string[1] - 0x30; //Atualiza o andar do elevador
            }
            if(string[0] == 'c'&& (int)string[1] == 49 && (int)string[2] >= 48 && (int)string[2] <= 53)
            {
              currentFloor = ((int) string[1] - 0x30)*10 + ((int) string[2] - 0x30); //Atualiza o andar do elevador
            }
            //if((int) string[1] == level)
      ...
      if(state == osOK)
      {
        ...
        switch(stateRightElevator)
        {
          case STOPPED:
            ...
            if(string[0] == 'd' && string[1] == 'E' && (int)string[2] == 48 && (int)string[3] >= 49 && (int)string[3] <= 57)
            {
              level = ((int) string[3] - 0x30);
            }
            if(string[0] == 'd' && string[1] == 'E' && (int)string[2] != 48 && (int)string[3] >= 49 && (int)string[3] <= 53)
            {
              level = ((int) string[2] - 0x30)*10 + ((int) string[3] - 0x30);
            }
            /*
          ...
          case GOING_UP:
            stateRightElevator = GOING_UP;
            if(string[0] == 'd' && (int)string[1] >= 49 && (int)string[1] <= 57 && (int)string[2] == 0)
            {
              currentFloor = (int) string[1] - 0x30; //Atualiza o andar do elevador
            }
            if(string[0] == 'd'&& (int)string[1] == 49 && (int)string[2] >= 48 && (int)string[2] <= 53)
            {
              currentFloor = ((int) string[1] - 0x30)*10 + ((int) string[2] - 0x30); //Atualiza o andar do elevador
            }
            //if((int) string[1] == level)
